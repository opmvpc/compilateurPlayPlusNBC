...
public class B314commentsSyntaxTest {
    ...
    @Test
    public void testcomments_aj_testlocalvariabledecl_while_local_var_diff_names_than_global_vars_but_same_name_in_main_ok_ok() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/comments/ok/aj_testlocalvariabledecl_while_local_var_diff_names_than_global_vars_but_same_name_in_main_ok.b314", testFolder.newFile(), true, "comments: aj_testlocalvariabledecl_while_local_var_diff_names_than_global_vars_but_same_name_in_main_ok");
    }

...
class CompilerTestHelper {
     ...
     *
     * @param input
     *            The name of the input B314 file (in src/test/resources).
     * @param ok
     *            True if the compiler should print 'OK' on stderr for the given files.
     * @param message
     *            Message to print if the test failes.
     * @param outputFile
     *            Output file where PCode is written
     * @throws URISyntaxException
     *             If the given file does not exist in src/test/resources.
     * @throws IOException
     *             If the method fails to create ta temporary output file in testFolder.
     */
